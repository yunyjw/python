...
# ssid daeduck_office.bat 파일 생성
s = open("C:\\Temp\\daeduck_office.bat", 'w')
netsh1 = 'netsh wlan add profile filename="C:\\Temp\\Wi-Fi-daeduck_office.xml" Interface="Wi-Fi" user=current'
netsh2 = 'netsh wlan connect ssid=daeduck_office name=daeduck_office interface=Wi-Fi'
netsh3 = 'netsh wlan set profileparameter name=daeduck_office connectionmode=auto'
s.write(netsh1)
s.write('\n')
s.write(netsh2)
s.write('\n')
...
import ctypes
office_bat = ('C:\\Temp\\daeduck_office.bat') 
ctypes.windll.shell32.ShellExecute(0, 'open', office_bat, None, None, 1)
